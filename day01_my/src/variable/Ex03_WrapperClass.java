...
public class Ex03_WrapperClass {
	public static void main(String[] args) {
		...
		// primitive type 과 1:1 대응되며, 클레스이므로 첫글자는 대문자로 처리
		...
		int t2 = Integer.valueOf("2486");	// 문자열 "2468"을 정수형태의 값으로 반환한다.
		int t3 = Integer.parseInt("1357");	// 문자열 "1357"을 int형태의 값으로 반환한다.
		
		System.out.println(t1);
		System.out.println(t2);
		System.out.println(t3);
		
		// wrapper class는 호환되는 primitive와 1:1대응만 가능하다.
		// 같은 정수라 해도, Byte와 Short은 서로 호환되지 않는다.
		Byte by3 = 12;
...
//		System.out.println(sh3);
		...
		Short sh32 = (short)(byte)by3;	// 변수 이름에 가까운 형변환부터 수행한다.
